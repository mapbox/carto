...
tree.Color.prototype = {
    ...
    toPerceptual: function() {
        if (this.perceptual) {
            ...
            var husl = husl.fromRGB(rgb[0] / 255, rgb[1] / 255, rgb[2] / 255);
            return new tree.Color([husl[0], husl[1] / 100, husl[2] / 100], this.a, true);
        }
    },
    ...
    toStandard: function() {
        if (!this.perceptual) {
            ...
            return new tree.Color([hsl[0], hsl[1], hsl[2]], this.a, false);
        }
    },
    ...
    operate: function(env, op, other) {
        ...
        return new tree.Color(result, this.a, this.perceptual);
    },
