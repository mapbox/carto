...
tree.Operation.prototype.clone = function () {
    var clone = Object.create(tree.Operation.prototype);
    clone.index = this.index;
    clone.rule = this.rule;
    clone.filename = this.filename;
    if (typeof this.op.clone === 'function') {
    ...
    _.forEach(this.operands, function (o) {
        if (typeof o.clone === 'function') {
            clone.operands.push(o.clone());
        }
        else {
            clone.operands.push(o);
        }
    });
    return clone;
};
